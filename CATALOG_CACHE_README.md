...
- **Основные каталоги** (`kupislona_catalogs_main`) - главные каталоги для главной страницы
- **Мега-меню** (`kupislona_catalogs_mega`) - полная структура каталогов для мега-меню
- **Структуры каталогов** (`kupislona_catalogs_structure_{slug}`) - детальная структура каждого каталога
